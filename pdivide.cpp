...
void pdivide(int n){
    ...
    subMatrix a = subMatrix(m1,0,0,n);
    subMatrix b = subMatrix(m2,0,0,n);
    float **res1m = init(n/2);
    ...
    thread worker1(wrapper,a11,b11,n/2,&x1);
    thread worker2(wrapper,a12,b21,n/2,&x2);
