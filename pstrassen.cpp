...
void strassen(int n){
    ...
    generate(mat1,n);
    generate(mat2,n);
    subMatrix a = subMatrix(mat1,0,0,n);
    subMatrix b = subMatrix(mat2,0,0,n);
    ...
    subMatrix m1 = subMatrix(init(n/2),0,0,n/2);
    subMatrix m2 = subMatrix(init(n/2),0,0,n/2);
    subMatrix m3 = subMatrix(init(n/2),0,0,n/2);
    subMatrix m4 = subMatrix(init(n/2),0,0,n/2);
    subMatrix m5 = subMatrix(init(n/2),0,0,n/2);
    subMatrix m6 = subMatrix(init(n/2),0,0,n/2);
    subMatrix m7 = subMatrix(init(n/2),0,0,n/2);
    float **c=init(n);
    ...
    thread worker6(wrapper,a2111,b1112,n/2,&m6);
    ...
    thread worker7(wrapper,a1222,b2122,n/2,&m7);
